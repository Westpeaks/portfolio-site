...
function Project( {title, description, tags, imageUrl}:ProjectProps) {
  ...
  return <section className='group bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 
  relative sm:h-[20rem] mb-3 sm:mb-8 last:mb-0 even:pl-8 hover:bg-gray-200 transition'>

    <div className='pt-4 pb-7 px-5 sm:pl-10 pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full 
    group-even:ml-[18rem]'>
